  ...
  return (
    <div className={`${ONBOARD_BLEED} bg-[#0c0c0e]`}>
      ...
      <div className={`relative z-10 flex min-h-0 flex-1 flex-col px-5 pb-6 ${ONBOARD_SAFE_TOP}`}>
        <p className="text-[12px] font-medium tracking-wide text-white/45">Attunia</p>
        <h1 className="font-display mt-3 max-w-[16ch] text-[clamp(1.85rem,7.2vw,2.45rem)] leading-[1.08] font-extrabold text-white">
          读懂你的
        ...
        <p className="mt-3 max-w-[34ch] text-[13px] leading-relaxed text-white/60 sm:text-[15px]">
          用冥想疗法，与大脑做一次温柔
          <b className="font-semibold text-white">调律</b>
          。先认识此刻的状态，再慢慢对齐节奏。
        </p>

        <div className="mt-5 shrink-0 rounded-[22px] border border-white/10 bg-white/8 px-4 py-3.5 backdrop-blur-[2px]">
          ...
          <p className="font-display mt-1 text-lg font-bold text-white sm:text-xl">
            佩戴 NeuroBand，先认识此刻的自己
          </p>
          <p className="mt-1.5 text-[12px] leading-relaxed text-white/55">
            Attunia 会记住你的基线，再陪你把疗法与大脑状态调到同一频率。
          </p>
        </div>
